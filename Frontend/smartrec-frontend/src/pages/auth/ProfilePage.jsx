...
/* ── UI-only fields not provided by GET /api/user/me ── */
...
const ProfilePage = () => {
  ...
  const validateForm = () => {
    ...
    if (!nameVal) {
      ...
      newErrors.name =
        "Vui lòng nhập đầy đủ cả họ và tên (ví dụ: Nguyễn Văn A)";
    } else if (nameVal.length > 50) {
      newErrors.name =
        "Họ và tên quá dài, vui lòng nhập chính xác tên thật của bạn";
    } else if (hasNumber || hasSpecialChar) {
      newErrors.name =
        "Họ và tên chỉ được chứa chữ cái, không chứa số hay ký hiệu";
    }
    ...
    if (!phoneVal) {
      ...
      newErrors.phone =
        "Định dạng số điện thoại không hợp lệ (VD: 0912345678 hoặc +84912345678)";
    }
                  ...
                  <div className="profile-edit-form-wrap">
                    ...
                    <div className="profile-notice-box security-notice">
                      ...
                      <div className="notice-text">
                        ...
                        <p>
                          Email không thể thay đổi sau khi tạo tài khoản. Nếu
                          bạn cần cập nhật email, vui lòng liên hệ với bộ phận
