...
/* â”€â”€ Settings sidebar tabs â”€â”€ */
const settingsTabs = [
  { key: "profile", label: "Há»“ sÆ¡ cÃ¡ nhÃ¢n", icon: "profile" },
  { key: "password", label: "Äá»•i máº­t kháº©u", icon: "lock" },
  { key: "roles", label: "Vai trÃ² & PhÃ¢n quyá»n", icon: "roles" },
  { key: "workspace", label: "Quáº£n lÃ½ Workspace", icon: "workspace" },
];
...
/* â”€â”€ Permissions table data â”€â”€ */
const rolesData = [
  {
  ...
  {
    name: "ThÃ nh viÃªn (Member)",
    description: "Quyá»n háº¡n thÃ´ng thÆ°á»ng",
    permissions: [true, false, false, true],
  },
  {
    name: "NgÆ°á»i xem (Viewer)",
    description: "Chá»‰ xem dá»¯ liá»‡u",
...
const ProfilePage = () => {
  ...
  useEffect(() => {
    ...
    const loadProfile = async () => {
      try {
        ...
        if (isMounted) {
          setLoadError(error.message || "KhÃ´ng thá»ƒ táº£i thÃ´ng tin há»“ sÆ¡.");
        }
      } finally {
  ...
  const handleAvatarChange = (e) => {
    ...
    if (file) {
      if (file.size > 5 * 1024 * 1024) {
        setToastMessage("áº¢nh táº£i lÃªn vÆ°á»£t quÃ¡ dung lÆ°á»£ng 5MB");
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setErrors({});
      setIsEditing(false);
      setToastMessage("ÄÃ£ lÆ°u thay Ä‘á»•i thÃ nh cÃ´ng!");
      setTimeout(() => setToastMessage(""), 3000);
    } catch (error) {
      const nextErrors = {};

      if (error?.code === "EMAIL_ALREADY_EXISTS") {
        nextErrors.email = "Email nÃ y Ä‘Ã£ Ä‘Æ°á»£c sá»­ dá»¥ng bá»Ÿi tÃ i khoáº£n khÃ¡c.";
      } else if (error?.code === "PHONE_ALREADY_EXISTS") {
        nextErrors.phone =
          "Sá»‘ Ä‘iá»‡n thoáº¡i nÃ y Ä‘Ã£ Ä‘Æ°á»£c sá»­ dá»¥ng bá»Ÿi tÃ i khoáº£n khÃ¡c.";
      } else if (error?.code === "INVALID_EMAIL") {
        nextErrors.email = error.message || "Email khÃ´ng há»£p lá»‡.";
      } else if (error?.code === "INVALID_PHONE") {
        nextErrors.phone = error.message || "Sá»‘ Ä‘iá»‡n thoáº¡i khÃ´ng há»£p lá»‡.";
      } else if (error?.code === "INVALID_FULL_NAME") {
        nextErrors.name = error.message || "Há» vÃ  tÃªn khÃ´ng há»£p lá»‡.";
  ...
  const handleChangePassword = async (event) => {
    ...
    if (!passwordForm.oldPassword) {
      nextErrors.oldPassword = "Vui lÃ²ng nháº­p máº­t kháº©u hiá»‡n táº¡i";
    }
    ...
    try {
      ...
      setPasswordErrors({ form: error?.message || "KhÃ´ng thá»ƒ Ä‘á»•i máº­t kháº©u" });
    } finally {
    ...
    <div className="dashboard-shell profile-page-shell">
      ...
      {showPasswordSuccess && (
        ...
        >
          <div className="password-success-modal">
            ...
            <h2 id="password-success-title">Äá»•i máº­t kháº©u thÃ nh cÃ´ng!</h2>
            <p>
              Máº­t kháº©u cá»§a báº¡n Ä‘Ã£ Ä‘Æ°á»£c cáº­p nháº­t. Báº¡n cÃ³ thá»ƒ Ä‘Äƒng nháº­p vá»›i máº­t
              kháº©u má»›i.
            </p>
            <button
      ...
      <aside className="profile-sidebar">
        <div className="profile-sidebar-top">
          ...
          <div className="profile-sidebar-label">CÃ€I Äáº¶T</div>
      ...
      <div className="dashboard-main">
        ...
        <div className="dashboard-content">
          ...
          {!isLoading && !loadError && (
            <>
              {/* â•â•â•â•â•â•â•â•â•â•â•â•â•â• TAB: Há»“ sÆ¡ cÃ¡ nhÃ¢n (Cháº¿ Ä‘á»™ Edit) â•â•â•â•â•â•â•â•â•â•â•â•â•â• */}
              {activeTab === "profile" && isEditing && (
                <div className="profile-edit-section">
                  <div className="profile-edit-header">
                    <h1>Chá»‰nh sá»­a há»“ sÆ¡</h1>
                  ...
                  <div className="profile-edit-form-wrap">
                    ...
                    <div className="profile-edit-avatar-box">
                      <div className="profile-avatar-ring large">
                        ...
                        <button
                          ...
                          title="Äá»•i áº£nh Ä‘áº¡i diá»‡n"
                          onClick={() =>
                      ...
                      <span className="avatar-upload-hint">
                        Táº£i lÃªn áº£nh PNG hoáº·c JPG (Tá»‘i Ä‘a 5MB)
                      </span>
                    </div>
                    ...
                    <div className="profile-form-grid">
                      ...
                      <div className="form-group">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setEditForm({ ...editForm, email: e.target.value.replace(/\s/g, "") })
                          }
                    ...
                    <div className="profile-notice-box security-notice">
                      ...
                      <div className="notice-text">
                        ...
                        <p>
                          Chá»‰ cÃ¡c trÆ°á»ng Há» vÃ  tÃªn, Email vÃ  Sá»‘ Ä‘iá»‡n thoáº¡i Ä‘Æ°á»£c
                          phÃ©p cáº­p nháº­t tá»« há»“ sÆ¡ cÃ¡ nhÃ¢n.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="profile-notice-box tip-notice">
                      <div className="notice-icon">{icons.bulb}</div>
                      <div className="notice-text">
                        <strong>Máº¹o nhá»</strong>
                        <p>
                          MÃ£ ID, phÃ²ng ban vÃ  chá»©c vá»¥ lÃ  dá»¯ liá»‡u há»‡ thá»‘ng, do Ä‘Ã³
                          chá»‰ hiá»ƒn thá»‹ vÃ  khÃ´ng thay Ä‘á»•i tá»« mÃ n hÃ¬nh nÃ y.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              {/* â•â•â•â•â•â•â•â•â•â•â•â•â•â• TAB: Há»“ sÆ¡ cÃ¡ nhÃ¢n (Cháº¿ Ä‘á»™ Xem) â•â•â•â•â•â•â•â•â•â•â•â•â•â• */}
              {activeTab === "profile" && !isEditing && (
                  ...
                  <div className="profile-info-card">
                    ...
                    <div className="profile-details-grid">
                      <div className="profile-detail-item">
                        <span className="profile-detail-label">MÃƒ ID</span>
                        <span className="profile-detail-value">
                          {displayUser.userCode || ""}
                        </span>
                      </div>
                      <div className="profile-detail-item">
                        <span className="profile-detail-label">Há»Œ VÃ€ TÃŠN</span>
                        <span className="profile-detail-value">
                          {displayUser.name || ""}
                        </span>
                      </div>
                      ...
                      <div className="profile-detail-item">
                        <span className="profile-detail-label">PHÃ’NG BAN</span>
                        <span className="profile-detail-value">
                          {displayUser.department || ""}
                        </span>
                      </div>
                      <div className="profile-detail-item">
                        <span className="profile-detail-label">CHá»¨C Vá»¤</span>
                        <span className="profile-detail-value">
              ...
              {activeTab === "password" && (
                <div className="profile-section password-section">
                  <div className="profile-section-header">
                    <div>
                      <h1>Äá»•i máº­t kháº©u</h1>
                      <p className="profile-section-desc">
                        Cáº­p nháº­t máº­t kháº©u Ä‘á»ƒ báº£o vá»‡ tÃ i khoáº£n cá»§a báº¡n.
                      </p>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    <div className="password-form-fields">
                      <div className="form-group">
                        <label htmlFor="old-password">Máº¬T KHáº¨U HIá»†N Táº I</label>
                        <div className="password-input-wrap">
                          <input
                            ...
                            onChange={(event) =>
                              setPasswordForm({
                                ...passwordForm,
                                oldPassword: event.target.value.replace(/\s/g, ""),
                              })
                            }
                          ...
                          <button
                            ...
                            aria-label={
                              visiblePasswords.oldPassword
                                ? "áº¨n máº­t kháº©u hiá»‡n táº¡i"
                                : "Hiá»‡n máº­t kháº©u hiá»‡n táº¡i"
                            }
                            onClick={() =>
                              setVisiblePasswords({
                                ...visiblePasswords,
                      ...
                      <div className="form-group">
                        <label htmlFor="new-password">Máº¬T KHáº¨U Má»šI</label>
                        <div className="password-input-wrap">
                          <input
                            id="new-password"
                          ...
                          <button
                            ...
                            aria-label={
                              visiblePasswords.newPassword
                                ? "áº¨n máº­t kháº©u má»›i"
                                : "Hiá»‡n máº­t kháº©u má»›i"
                            }
                            onClick={() =>
                              setVisiblePasswords({
                                ...visiblePasswords,
                      ...
                      <div className="form-group">
                        <label htmlFor="confirm-password">
                          XÃC NHáº¬N Máº¬T KHáº¨U Má»šI
                        </label>
                        <div className="password-input-wrap">
                          <input
                            id="confirm-password"
                          ...
                          <button
                            ...
                            aria-label={
                              visiblePasswords.confirmPassword
                                ? "áº¨n xÃ¡c nháº­n máº­t kháº©u"
                                : "Hiá»‡n xÃ¡c nháº­n máº­t kháº©u"
                            }
                            onClick={() =>
                              setVisiblePasswords({
                                ...visiblePasswords,
                      ...
                      <div className="password-requirements-note">
                        Máº­t kháº©u má»›i gá»“m 8-16 kÃ½ tá»±, cÃ³ chá»¯ hoa, chá»¯ thÆ°á»ng, chá»¯
              ...
              {/* â•â•â•â•â•â•â•â•â•â•â•â•â•â• TAB: Vai trÃ² & PhÃ¢n quyá»n â•â•â•â•â•â•â•â•â•â•â•â•â•â• */}
              {activeTab === "roles" && (
                <div className="profile-section">
                  <div className="profile-section-header">
                    <div>
                      <h1>Quáº£n lÃ½ vai trÃ²</h1>
                      <p className="profile-section-desc">
                        XÃ¡c Ä‘á»‹nh cÃ¡c má»©c Ä‘á»™ truy cáº­p vÃ  quyá»n háº¡n cho cÃ¡c thÃ nh
                        viÃªn trong Workspace.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="profile-roles-table-wrap">
                    <table className="profile-roles-table">
                      <thead>
                        <tr>
                          <th className="roles-th-name">VAI TRÃ’</th>
                  ...
                  <div className="profile-tip-box">
                    ...
                    <div className="profile-tip-content">
                      <strong>Máº¹o nhá»</strong>
                      <p>
                        Báº¡n cÃ³ thá»ƒ tÃ¹y chá»‰nh tá»«ng quyá»n háº¡n cá»¥ thá»ƒ cho thÃ nh
                        viÃªn trong pháº§n Quáº£n lÃ½ Workspace. Äá»«ng quÃªn lÆ°u láº¡i
                        thay Ä‘á»•i sau khi cáº­p nháº­t nhÃ©!
                      </p>
                    </div>
                  </div>
                </div>
