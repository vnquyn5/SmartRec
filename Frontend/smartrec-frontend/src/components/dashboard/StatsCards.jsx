...
const cards = [
  {
    ...
    icon: (
      <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
        ...
        <path d="M8 2v4M14 2v4M2 9h18" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      </svg>
    ),
  },
  {
  ...
  },
  {
    ...
    icon: (
      <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
        <path d="M11 2L2 7v8l9 5 9-5V7l-9-5z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
        <path d="M2 7l9 5 9-5M11 12v10" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
      </svg>
    ),
  },
];
